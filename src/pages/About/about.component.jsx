      ...
      <div className='container about-fade'>
        <div className='row'>
          <div className='col test'>
            ...
            <p className='about-text'>My name is Kerry Smith. I am a Full Stack Web Developer with interests in front-end JavaScript libraries and UI/UX design. When we can visualize data, the design develops intuitively and most importantly, it develops naturally. To see the front and back-end come together bit by bit is truly rewarding.</p>
